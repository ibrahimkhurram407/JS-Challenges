...
function RPSFrontEnd(HumanChoice, BotChoice, message) {
  ...
  HumanDiv.innerHTML =
    ...
    "' style='box-shadow: 6px 6px 15px blue;'>";
  BotDiv.innerHTML =
    "<img src='" +
    ImagesDataBase[BotChoice] +
    "' style='box-shadow: 6px 6px 15px red;'>";
...
function BlackJackDeal() {
  if (BlackJackDealData["turnOver"] == true) {
    ...
    document.getElementById("What-we-do").textContent = "Let's Play!";
    document.getElementById("What-we-do").style.color = "black";
...
function computeWinner() {
  let winner = null;
  //condition: higher score than dealer or when dealer busts but you don't
  if (YOU["score"] <= 21) {
    if (YOU["score"] > DEALER["score"] || DEALER["score"] > 21) {
      BlackJackGameDataBase["wins"]++;
      winner = YOU;
...
function showResult(winner) {
  if (BlackJackGameDataBase["turnsOver"] == true){
    ...
    if (winner === YOU) {
        document.querySelector("#Wins").textContent = BlackJackGameDataBase["wins"];
        message = "You Won!";
        messageColor = "green";
        Cash.play();
    ...
    document.querySelector("#What-we-do").textContent = message;
    document.querySelector("#What-we-do").style.color = messageColor;
